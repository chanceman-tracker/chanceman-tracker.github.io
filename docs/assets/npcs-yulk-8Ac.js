import{f as e,N as R,i as $}from"./index-DI5X35h9.js";import{b as k,g as w,a as L,f as D}from"./npcDropEntries-CC0KyFe4.js";function p(s){return String(s).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function P(s){return/^Reward casket \(/i.test(s||"")}async function T(){if(!e.player)return`
            <h1>NPC drops</h1>
